...
export function SignInWithGoogleButton({ redirectUrl }: { redirectUrl: string }) {
    ...
    return (
        <button className="w-full gsi-material-button" onClick={handleGoogleLogin}>
            ...
            <div className="gsi-material-button-content-wrapper">
              ...
              <span className="gsi-material-button-contents">使用Google帳戶登入</span>
              <span style={{ display: 'none' }}>使用Google帳戶登入</span>
            </div>
        </button>
    )
